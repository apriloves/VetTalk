...
<div class="card shadow mb-4">
            ...
            <h4 class="m-2 font-weight-bold text-primary" style="text-align:center">Laboratory Results List</h4> 
            </div>
...
<hr>
          ...
          <table class="table table-bordered" width="100%" cellspacing="0">
            ...
            <tbody>
  <?php
           $query = 'SELECT *, CONCAT(P.FIRST_NAME," ", P.LAST_NAME) AS FIRST_NAME, T.CUST_ID, T.LAB_ID, T.date, tt.PET_NAME, u.ID, CONCAT(e.FIRST_NAME," ", e.LAST_NAME) AS  EMP_NAME FROM lab_rec R
           ...
           WHERE T.`CUST_ID` = '.$_SESSION['CUST_ID'].'';
