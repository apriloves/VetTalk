<?php 
    ...
    {
        $main_id = $_GET['id'];
        $sql_update = mysqli_query($db,"UPDATE notif_user SET status=1 WHERE id = '$main_id' ");
    }
                        ...
                        <div class="col-md-12">
                            <table class="table">
                                ...
                                <tbody>
                                    <?php
                                        $sr_no = 1;
                                        $sql_get = mysqli_query($db, "SELECT * FROM notif_user WHERE id = '$main_id' AND cust_id={$_SESSION['CUST_ID']} AND status=1");
