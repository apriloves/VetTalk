...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <h3 class="m-0 font-weight-bold text-primary" style="text-align:center"> Laboratory Appointments 
    ...
    <div class="card-body">
        ...
        <?php
            ...
            $query = 'SELECT * FROM lab_bookings WHERE status = "Approved" AND CUST_ID = '.$_SESSION['CUST_ID'].'';
