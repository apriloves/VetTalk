...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <h3 class="m-0 font-weight-bold text-primary" style="text-align:center"> Cancelled Appointment(s)
    ...
    <div class="card-body">
        ...
        <?php
            $query = "SELECT * FROM lab_bookings WHERE status='Denied' OR status='Cancelled'";
                    ...
                    <?php
                        ...
                        <td>
                            <form action="bookings_edit.php" method="post">
                                <input type="hidden" name="edit_id" value="<?php echo $row['LAB_ID'];?>" >
