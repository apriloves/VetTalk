...
<?php
    ...
    function build_calendar($month, $year)
    {
        ...
        /*$query = $db->prepare('SELECT * FROM bookings WHERE MONTH(date)=? AND YEAR(date)=? ');
        ...
        while($currentDay <= $numberDays)
        {
            ...
            {
                $calendar.="<td><h5>$currentDay</h5> <a href='bookings.php?date=".$date."'class='btn btn-secondary   btn xs'> View 
                </a>
                </td>";
            }
            else
            {
                ...
                if($totalbookings > 6)
                {
                    $calendar.="<td class='$today'><h5>$currentDay</h5> <a href='bookings.php?date=".$date."'class='btn btn-success btn xs'> View 
                    </a>";
                }
                else
                {
